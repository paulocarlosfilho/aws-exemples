...
# Script: Converter JSON da AWS para formato TOON (otimizado para Gemini)
# Uso: <comando-aws> | ./aws_to_toon.sh
# Exemplo: aws s3api list-objects --bucket meu-bucket | ./aws_to_toon.sh
...
# Usa o python3 para formatar o TOON de forma simples
python3 -c "
import sys, json
